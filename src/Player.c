...
void initializePlayerRyu( float x, float y, Player *p, DurationMode animationDurationMode, bool showBoxes, bool showDebugInfo ) {
    ...
    p->hitUpStandingAnim.frames[0] = (AnimationFrame) { {  1, 3829, -96, 96 }, 60, { 0, 0 }, .boxes = { 0 } };
    p->hitUpStandingAnim.frames[1] = (AnimationFrame) { { 98, 3829, -96, 96 }, 60, { 0, 0 }, .boxes = { 0 } };
    ...
    p->hitMidStandingAnim.frames[0] = (AnimationFrame) { {  1, 3732, -96, 96 }, 60, { 0, 0 }, .boxes = { 0 } };
    p->hitMidStandingAnim.frames[1] = (AnimationFrame) { { 98, 3732, -96, 96 }, 60, { 0, 0 }, .boxes = { 0 } };
    ...
    p->hitCrouchAnim.frames[0] = (AnimationFrame) { {  1, 3926, -96, 80 }, 60, { 0, 0 }, .boxes = { 0 } };
    p->hitCrouchAnim.frames[1] = (AnimationFrame) { { 98, 3926, -96, 80 }, 60, { 0, 0 }, .boxes = { 0 } };
    ...
    p->defenceStandingAnim.frames[1] = (AnimationFrame) { { 82, 3569, -80, 96 }, 60, { 0, 0 }, .boxes = { 0 } };
    ...
    p->defenceCrouchAnim.frames[1] = (AnimationFrame) { { 82, 3666, -80, 65 }, 60, { 0, 0 }, .boxes = { 0 } };
