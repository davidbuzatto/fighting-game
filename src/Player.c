...
void initializePlayerRyu( float x, float y, Player *p ) {
    ...
    p->crouchingAnim.frames[0] = (AnimationFrame) { (Rectangle) {   1, 352, -80, 96 }, 30 };
    p->crouchingAnim.frames[1] = (AnimationFrame) { (Rectangle) {  82, 352, -80, 96 }, 30 };
    p->crouchingAnim.frames[2] = (AnimationFrame) { (Rectangle) { 163, 352, -80, 96 }, 30 };

    int animationCount = 0;
    p->animations[0] = &p->idleAnim; animationCount++;
    p->animations[1] = &p->forwardAnim; animationCount++;
    p->animations[2] = &p->backwardAnim; animationCount++;
    p->animations[3] = &p->straightJumpAnim; animationCount++;
    p->animations[4] = &p->forwardJumpAnim; animationCount++;
    p->animations[5] = &p->backwardJumpAnim; animationCount++;
    p->animations[6] = &p->crouchingAnim; animationCount++;
